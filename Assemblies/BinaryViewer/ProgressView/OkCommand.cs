...
namespace BinaryViewer.ProgressView
{
    public class OkCommand : ICommand
    {
        ...
        public OkCommand(IProgressViewModel viewModel)
        {
        ...
        {
            if (e.PropertyName == nameof(_viewModel.CompleteSuccess) ||
        ...
        {
            return _viewModel.CompleteSuccess || _viewModel.CompleteCanceled || _viewModel.CompleteError;
        }
        ...
        public void Execute(object parameter)
        {
            ...
            if (_viewModel.CompleteSuccess)
            {
                _viewModel.OnSuccessHandler?.Invoke(_viewModel.Result);
            }
        }
    }
}
